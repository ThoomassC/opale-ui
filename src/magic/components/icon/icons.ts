...
/* =============================================================================
   LES MOTS FRANÇAIS DE CHAQUE ICÔNE.

   LES NOMS DU JEU SONT ANGLAIS, ET LE FILTRE NE CHERCHAIT QUE LÀ. La page
   soufflait pourtant « valise, carte, flèche » dans son champ : trois mots
   qu'elle ne pouvait PAS trouver, puisqu'ils s'appellent `luggage`, `map` et
   `arrow`. L'utilisateur tapait ce que la page lui proposait et lisait
   « Aucune icône ne correspond » — le seul chemin que la page existait pour
   servir était le seul qu'elle ne servait pas.

   LES NOMS RESTENT ANGLAIS parce que ce sont des identifiants de code, et que
   le dépôt écrit son code en anglais. Ce sont donc les MOTS DE RECHERCHE qui
   sont traduits, pas les clés.

   PLUSIEURS MOTS PAR ICÔNE, ET DES SYNONYMES : on ne cherche pas « trash », on
   cherche « supprimer » ou « corbeille » selon ce qu'on a en tête. Les entrées
   contiennent aussi l'INTENTION et pas seulement l'objet — `check-circle` se
   trouve par « succès », `x-circle` par « échec ».
   ========================================================================== */
export const ICON_KEYWORDS: Record<OpaleIconName, string> = {
  'arrow-up': 'flèche haut monter',
  'arrow-down': 'flèche bas descendre',
  'arrow-left': 'flèche gauche retour précédent',
  'arrow-right': 'flèche droite suivant continuer',
  'chevron-up': 'chevron haut replier',
  'chevron-down': 'chevron bas déplier dérouler',
  'chevron-left': 'chevron gauche précédent',
  'chevron-right': 'chevron droite suivant',
  'chevrons-left': 'double chevron gauche début premier',
  'chevrons-right': 'double chevron droite fin dernier',
  'corner-turn': 'virage bifurcation renvoi réponse',
  home: 'maison accueil départ',
  menu: 'menu burger navigation lignes',
  close: 'fermer croix annuler quitter',
  'external-link': 'lien externe nouvel onglet sortir',
  'more-horizontal': 'plus options points suite',
  'more-vertical': 'plus options points suite vertical',
  plus: 'plus ajouter créer nouveau',
  minus: 'moins retirer soustraire',
  check: 'coche valider validé oui accepter',
  search: 'recherche loupe chercher trouver',
  edit: 'crayon modifier éditer écrire',
  trash: 'poubelle supprimer effacer jeter corbeille',
  copy: 'copier duplique duplication presse-papier',
  download: 'télécharger descendre importer récupérer',
  upload: 'téléverser envoyer monter déposer',
  refresh: 'rafraîchir recharger actualiser recommencer',
  filter: 'filtre entonnoir affiner trier',
  sort: 'trier ordre classement croissant',
  share: 'partager partage envoyer diffuser',
  save: 'enregistrer sauvegarder disquette',
  print: 'imprimer impression imprimante',
  settings: 'réglages paramètres options curseurs configuration',
  'drag-handle': 'poignée déplacer glisser réordonner',
  file: 'fichier document page',
  'file-text': 'fichier texte document lignes',
  folder: 'dossier répertoire classeur',
  'folder-open': 'dossier ouvert répertoire',
  image: 'image photo illustration visuel',
  paperclip: 'trombone pièce jointe attacher',
  archive: 'archive boîte ranger stocker',
  clipboard: 'presse-papier bloc-notes coller',
  book: 'livre carnet guide lecture documentation',
  layers: 'calques couches empilement strates',
  mail: 'courrier email enveloppe message',
  send: 'envoyer avion message expédier',
  chat: 'discussion bulle conversation message commentaire',
  bell: 'cloche notification alerte rappel',
  'bell-off': 'cloche barrée notification coupée silence',
  phone: 'téléphone appel combiné',
  'at-sign': 'arobase email adresse mention',
  megaphone: 'mégaphone annonce porte-voix communication',
  user: 'utilisateur personne profil compte',
  users: 'utilisateurs personnes groupe équipe',
  'user-plus': 'ajouter utilisateur inviter nouveau membre',
  lock: 'cadenas verrouillé sécurité fermé privé',
  unlock: 'cadenas ouvert déverrouillé accès',
  key: 'clé accès mot de passe jeton',
  'shield-check': 'bouclier sécurité protection vérifié confiance',
  info: 'information renseignement aide détail',
  'alert-triangle': 'attention avertissement danger triangle',
  'alert-circle': 'alerte attention important',
  'check-circle': 'validé succès confirmé réussi',
  'x-circle': 'erreur échec refusé annulé',
  'help-circle': 'aide question interrogation support',
  star: 'étoile favori note évaluation',
  heart: 'cœur aimer favori coup de cœur',
  bookmark: 'signet marque-page enregistrer garder',
  flag: 'drapeau signaler marquer étape',
  ban: 'interdit bloqué refusé interdiction',
  play: 'lecture jouer démarrer lancer',
  pause: 'pause suspendre arrêter',
  stop: 'arrêt stop carré',
  'skip-back': 'précédent reculer piste',
  'skip-forward': 'suivant avancer piste',
  volume: 'volume son haut-parleur audio',
  'volume-off': 'muet son coupé silence',
  camera: 'appareil photo caméra cliché',
  mic: 'micro microphone enregistrement voix',
  clock: 'horloge heure temps montre',
  calendar: 'calendrier date agenda planning jour',
  history: 'historique passé versions journal',
  hourglass: 'sablier attente durée',
  timer: 'minuteur chronomètre compte à rebours',
  map: 'carte plan géographie itinéraire',
  'map-pin': 'épingle lieu position point carte adresse',
  compass: 'boussole orientation direction explorer',
  plane: 'avion vol voyage aéroport',
  train: 'train gare rail chemin de fer',
  car: 'voiture auto véhicule route',
  bike: 'vélo bicyclette cycle',
  boat: 'bateau voilier mer navigation',
  globe: 'globe monde terre international langue',
  luggage: 'valise bagage voyage malle',
  ticket: 'billet ticket entrée réservation',
  sun: 'soleil clair jour thème lumière',
  moon: 'lune sombre nuit thème',
  cloud: 'nuage nuageux ciel distant',
  rain: 'pluie averse pluvieux',
  snow: 'neige neigeux flocon froid',
  wind: 'vent brise souffle',
  'chart-bar': 'graphique barres histogramme statistiques',
  'chart-line': 'graphique courbe tendance évolution',
  'chart-pie': 'graphique camembert secteurs répartition',
  'trending-up': 'hausse croissance progression flèche montante',
  'trending-down': 'baisse recul chute flèche descendante',
  grid: 'grille mosaïque vignettes tuiles',
  list: 'liste énumération puces',
  table: 'tableau tableur colonnes lignes',
  'shopping-bag': 'sac achat courses boutique',
  'shopping-cart': 'panier chariot caddie commande',
  'credit-card': 'carte bancaire paiement crédit',
  tag: 'étiquette libellé prix catégorie',
  gift: 'cadeau offre paquet surprise',
  wallet: 'portefeuille porte-monnaie solde',
  eye: 'œil voir afficher visible aperçu',
  'eye-off': 'œil barré masquer caché invisible',
  'zoom-in': 'zoom avant agrandir grossir',
  'zoom-out': 'zoom arrière réduire rétrécir',
  link: 'lien chaîne maillon url',
  code: 'code chevrons balises développement',
  terminal: 'terminal console commande shell',
  sparkle: 'étincelle magie nouveauté brillance',
  palette: 'palette couleurs peinture thème',
  power: 'alimentation marche arrêt bouton',
};
