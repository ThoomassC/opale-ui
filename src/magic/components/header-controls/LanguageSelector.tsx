...
const LANGUAGE_OPTIONS: readonly { value: HeaderLanguage; label: string }[] = [
...
function htmlLangOf(language: HeaderLanguage): string {
...
export interface LanguageSelectorProps {
  ...
  /** Conserve les classes historiques de la vitrine sur son propre header. */
...
export function LanguageSelector({
  ...
  return (
    <div
      className={clsx(siteClassNames && 'tc-doc-language', styles.language)}
      ref={wrapperRef}
      onBlur={(event) => {
    ...
    >
      ...
      <span className={clsx(siteClassNames && 'tc-visually-hidden', styles.srOnly)} id={labelId}>
        {label}
      </span>

      <button
        className={clsx(siteClassNames && 'tc-doc-language__trigger', styles.languageTrigger)}
        id={triggerId}
        type="button"
        role="combobox"
      ...
      >
        <LanguageFlag
          className={clsx(siteClassNames && 'tc-doc-language__flag', styles.flag)}
          language={selected.value}
        />
        <span
          className={clsx(siteClassNames && 'tc-visually-hidden', styles.srOnly)}
          lang={htmlLangOf(selected.value)}
        >
          {selected.label}
        </span>
        <span
          className={clsx(siteClassNames && 'tc-doc-language__caret', styles.caret)}
          aria-hidden="true"
        />
      </button>
      ...
      <ul
        className={clsx(siteClassNames && 'tc-doc-language__list', styles.languageList)}
        id={listId}
        role="listbox"
      ...
      >
        {LANGUAGE_OPTIONS.map((option, index) => (
          ...
          <li
            className={clsx(siteClassNames && 'tc-doc-language__option', styles.option)}
            id={optionId(index)}
            key={option.value}
            role="option"
