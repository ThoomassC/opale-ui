...
export const OPALE_CATALOG: readonly CatalogEntry[] = [
  ...
  ['InlineInput', 'Inputs', "Alias d'Input."],
  ...
  ['Card', 'Affichage de données', 'Carte avec titre, sous-titre, actions et pied.'],
  ['CardGrid', 'Affichage de données', 'Grille responsive auto-adaptative pour cartes.'],
  ['DataTable', 'Affichage de données', 'Table de données à colonnes déclarées.'],
  ...
  ['Badge', 'Affichage de données', 'Pastille de texte en trois tons.'],
  ...
  ['Breadcrumb', 'Navigation', "Fil d'Ariane en liste ordonnée, séparateurs tus aux lecteurs d'écran."],
  ['CookieBanner', 'Navigation', "Bandeau de consentement avec bouton d'acceptation."],
  ...
  ['Dropzone', 'Modules', 'Zone de choix de fichiers par le sélecteur natif.'],
  ['Lightbox', 'Modules', "Visionneuse d'image en modale, texte alternatif obligatoire."],
  ['Clipboard', 'Modules', 'Bouton de copie dans le presse-papier.'],
